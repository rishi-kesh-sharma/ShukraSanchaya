...
const showDonorDashboardOverview=(req,res,next)=>{
  
    res.render("./pages/dashboard/donorDashboard/overview",{user:req.user})

}
const showDonorDashboardMyAppointments=(req,res,next)=>{
   ...
   .then((appointmentResponse)=>{
    ...
    res.render("./pages/dashboard/donorDashboard/myAppointments",{appointments:data,user:req.user})
...
const showDonorDashboardDeleteAccountConfirmationForm=(req,res,next)=>{
  
    res.render("./pages/dashboard/donorDashboard/deleteAccount",{user:req.user})
...
const showDeleteDonorAccountConfirmationForm=(req,res,next)=>{

    res.render("./pages/dashboard/donorDashboard/deleteDonorAccount",{user:req.user})

   

}

const deleteDonorAccountAction=(req,res,next)=>{
    axios.delete(`http://localhost:3000/api/donor/me/${req.params.userId}`,
    {
         withCredentials:true,
         headers:{
         Cookie: `token=${req.cookies.token}`
...
module.exports={showDonorDashboardMyAppointments,showDonorDashboardDeleteAccountConfirmationForm,showDonorDashboardOverview,deleteAccountAction,showDeleteDonorAccountConfirmationForm,deleteDonorAccountAction}
